...
module ol_init
  ...
  subroutine setparameter_int(param, val, err)
    ...
    if (verbose > 3) then
      print*, "[OpenLoops] setparameter_int: ", param, val
    end if
  ...
  subroutine setparameter_double(param, val, err)
    ...
    if (verbose > 3) then
      print*, "[OpenLoops] setparameter_double: ", param, val
    end if
    ...
    select case (param)
      ...
      case ("mass(1)", "d_mass", "rmd")
        ...
        call set_if_modified(YD_unscaled, val)
      ...
      case ("mass(2)", "u_mass", "rmu")
        ...
        call set_if_modified(YU_unscaled, val)
      ...
      case ("mass(3)", "s_mass", "rms")
        ...
        call set_if_modified(YS_unscaled, val)
      ...
      case ("mass(4)", "c_mass", "rmc")
        ...
        call set_if_modified(YC_unscaled, val)
      ...
      case ("mass(5)", "b_mass", "rmb")
        ...
        call set_if_modified(YB_unscaled, val)
      ...
      case ("mass(6)", "t_mass", "rmt")
        ...
        call set_if_modified(YT_unscaled, val)
      ...
      case ("mass(11)", "e_mass", "rme")
        ...
        call set_if_modified(YE_unscaled, val)
      ...
      case ("mass(13)", "mu_mass", "rmm")
        ...
        call set_if_modified(YM_unscaled, val)
      ...
      case ("mass(15)", "tau_mass", "rml")
        ...
        call set_if_modified(YL_unscaled, val)
  ...
  subroutine setparameter_string(param, val, err)
    ...
    select case (param)
      ...
      case ("allowed_libs", "allowed_libraries", "allowedlibs", "allowedlibraries")
        if (len(val) >= max_parameter_length) then
          print *, "[OpenLoops] ol_setparameter_string: allowed_libs must not exceed 254 characters"
          stop
        end if
        allowed_libs = val
