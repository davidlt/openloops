...
!   use TI_call_interface
  ...
  real(REALKIND), save :: YE_unscaled = 0
  real(REALKIND), save :: YM_unscaled = 0
  real(REALKIND), save :: YL_unscaled = 0
  real(REALKIND), save :: YU_unscaled = 0
  real(REALKIND), save :: YD_unscaled = 0
  real(REALKIND), save :: YS_unscaled = 0
  real(REALKIND), save :: YC_unscaled = 0
  real(REALKIND), save :: YB_unscaled = 0
  real(REALKIND), save :: YT_unscaled = 172._/**/REALKIND
  ...
  real(REALKIND), save :: rME, wME, YE
  real(REALKIND), save :: rMM, wMM, YM
  real(REALKIND), save :: rML, wML, YL
  real(REALKIND), save :: rMU, wMU, YU
  real(REALKIND), save :: rMD, wMD, YD
  real(REALKIND), save :: rMS, wMS, YS
  real(REALKIND), save :: rMC, wMC, YC
  real(REALKIND), save :: rMB, wMB, YB
  real(REALKIND), save :: rMT, wMT, YT
...
! ifdef PRECISION_dp
  ...
  complex(REALKIND), save :: MY2sum, MY2sum_pairs
